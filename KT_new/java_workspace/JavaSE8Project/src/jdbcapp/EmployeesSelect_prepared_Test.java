...
public class EmployeesSelect_prepared_Test {
...
//		char c = sc.next().charAt(0);
		...
		builder.append("select employee_id,  first_name , email, salary , hire_date ").append(" from employees")
				.append("  where first_name like '" + param + "%'");
		String sql = builder.toString();
		System.out.println(sql);

//		String sql = "select employee_id,  first_name , email, salary , hire_date from employees where first_name like '"
//				+ c + "%'";
